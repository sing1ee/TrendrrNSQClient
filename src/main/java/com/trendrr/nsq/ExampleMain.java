...
public class ExampleMain {
	...
	public static void main(String[] args) throws InterruptedException,
		...
		// */
		// //producer
		// NSQProducer producer = new NSQProducer().addAddress("localhost",
		// 4150, 1);
		// producer.start();
		// start = new Date();
		...
		// // }
		// //
		// //// My System does this in about 10 seconds, so 5k messages per
		// second on a single connection
		// // System.out.println("Produced 50k messages in " + (new
		// Date().getTime()-start.getTime()) + " millis");
		// //
		//
		// start = new Date();
		// for (int i=0; i < 50000; i++) {
		...
		// }
		//
		// // My System does this in about 10 seconds, so 5k messages per second
		// on a single connection
		// System.out.println("Produced 50k batch messages in " + (new
		// Date().getTime()-start.getTime()) + " millis");
		//
		//
		// if (true)
		...
		lookup.addAddr("hg006", 4161);
		lookup.addAddr("hg007", 4161);

		start = new Date();
		/**
		 * Consumer. consume 50k messages and immediately exit
		 */
		NSQConsumer consumer = new NSQConsumer(lookup, args[0], "java_ss",
				new NSQMessageCallback() {
					...
					public void message(NSQMessage message) {
						try {
							...
							System.out.println(new String(message.getMessage()).split("\t")[0]);
